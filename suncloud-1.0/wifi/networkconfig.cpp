...
void NetworkConfig::paramsFromScanResults(const QString &_ssid,const QString &_wpa,const QString &_bssid)
{
	new_network = true;

	/* SSID BSSID frequency signal flags */
	setWindowTitle(_ssid);
	ssidEdit->setText(_ssid);
...
void NetworkConfig::setWpaGui(Wifi *_wpagui)
{
	wpagui = _wpagui;
}
