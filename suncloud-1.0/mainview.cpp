    ...
    ui(new Ui::mainview)
{
    ...
    else
    {
        ...
        QFile  file_eth("/root/wpa_supplicant.conf");
...
void    mainview::paintEvent(QPaintEvent *)
{
    ...
    {
    map = new  QPixmap("./images/wifi_img.png");
...
#if 0
void mainview::outputMessage(QtMsgType type, const QMessageLogContext &context, const QString &msg)
{
    static QMutex mutex;
    mutex.lock();
